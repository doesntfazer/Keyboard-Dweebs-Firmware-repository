...
ZSFT = KC.MT(KC.Z, KC.LSFT, prefer_hold=True, tap_interrupted=True, tap_time=3000)
SLSHSFT = KC.MT(KC.SLSH, KC.LSFT, prefer_hold=True, tap_interrupted=True, tap_time=3000)
...
keyboard.keymap = [
    ...
    [ #LOWER
     KC.TRNS,  KC.B,  KC.D,     KC.R,    KC.T,     KC.Y,    KC.U,     KC.I,    KC.O,   KC.P, 
     KC.A,  KC.P,  KC.D,     KC.F,    KC.G,     KC.H,    KC.J,     KC.K,    KC.L,   KC.QUOT, 
     KC.Z,  KC.X,  KC.C,     KC.V,    KC.B,     KC.N,    KC.M,     KC.COMM, KC.DOT, KC.SLSH,
     KC.NO, KC.NO, KC.Q,     KC.W,    KC.SPACE, KC.BSPC, KC.T,     KC.Y,    KC.NO,  KC.NO,
